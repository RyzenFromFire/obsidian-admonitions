...
* add a toggle for MS syntax in live preview ([8b73f47](https://github.com/RyzenFromFire/obsidian-admonitions/commit/8b73f47b60d2984deee062ac396dc0562f5cb535))
* add live preview support to new blockquote admonitions ([936199c](https://github.com/RyzenFromFire/obsidian-admonitions/commit/936199c182767d7563e60c03f414db2de1d18ab1))
* added ability to default to no title ([0983790](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0983790cd930657d69c96c885c23eabcb884987e))
* added ability to globally turn off Admonition Color being set directly on element ([afbcc23](https://github.com/RyzenFromFire/obsidian-admonitions/commit/afbcc235dd3314ec779f44a25c4ffda74e0acaf1))
* Added Icon Packs (close [#181](https://github.com/RyzenFromFire/obsidian-admonitions/issues/181)) ([e973cec](https://github.com/RyzenFromFire/obsidian-admonitions/commit/e973cec353a656112f9310c64afb7780ba8590c3))
* added per-admonition copy button setting (close [#118](https://github.com/RyzenFromFire/obsidian-admonitions/issues/118)) ([0983790](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0983790cd930657d69c96c885c23eabcb884987e))
* added setting to turn off title parsing (close [#123](https://github.com/RyzenFromFire/obsidian-admonitions/issues/123)) ([0983790](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0983790cd930657d69c96c885c23eabcb884987e))
* Adds ability to convert code block admonitions to callouts in settings. ([3f5c6f0](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3f5c6f0f93f059cf50009366f331edd335632afa))
* adds admonition exporting ([0897e08](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0897e08647ac6158c31d99383dd65e21381c5f1e))
* adds admonition importing ([723f2fb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/723f2fb4fb88d372cb424dbb139fc1567d169c7d))
* adds Drop Shadow setting to remove drop shadow ([d6d598e](https://github.com/RyzenFromFire/obsidian-admonitions/commit/d6d598eee14a894c0ef06b6291a51f21f0c67967))
* adds Hide Empty Admonitions setting (close [#171](https://github.com/RyzenFromFire/obsidian-admonitions/issues/171)) ([bf379bf](https://github.com/RyzenFromFire/obsidian-admonitions/commit/bf379bf5de32236dc0ca4bfa7b03a3768f3be090))
* Adds MSDoc-style admonitions (close [#133](https://github.com/RyzenFromFire/obsidian-admonitions/issues/133)) ([3af3922](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3af392265a6ec8f27002ece8a61d0f9d65626484))
* Adds Obsidian's icon set to list of icons ([e17b75a](https://github.com/RyzenFromFire/obsidian-admonitions/commit/e17b75a01a84426824dd447596da7e732991b824))
* Adds setting to use CSS snippet to manage custom callouts ([cdd5b85](https://github.com/RyzenFromFire/obsidian-admonitions/commit/cdd5b8543a32e2cf0071db53f288d9938dbcb81f))
* Adds support for HSL, HSB, HSV, HEX and RGB colors in Admonition definitions (thanks [@x](https://github.com/x)Ryul ) ([a872858](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a8728585e65e853d16eebebf52f33aa84755e9e4))
* adds support for indented code blocks using MSDoc syntax (close [#176](https://github.com/RyzenFromFire/obsidian-admonitions/issues/176)) ([9c9e6ac](https://github.com/RyzenFromFire/obsidian-admonitions/commit/9c9e6ac6e1340a16eb498b1df321cd5fd2b3b9a6))
* Admonitions has been updated to support the new Obsidian callouts feature! Check the Readme for more information on what this means. ([3697e4b](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3697e4b60ca34ad703555de19f0b21f628aea530))
* Admonitions now mimics the structure of callouts ([1ba0085](https://github.com/RyzenFromFire/obsidian-admonitions/commit/1ba0085258fed225514632b6aefd5d1cb79f897a))
* Better Autocompletion for Callouts (thanks [@heinrich26](https://github.com/heinrich26)) ([d367e05](https://github.com/RyzenFromFire/obsidian-admonitions/commit/d367e05e650989c17977c2959935fb6705057cef))
* Callouts now receive the "copy content" button if turned on in Admonition settings ([266efde](https://github.com/RyzenFromFire/obsidian-admonitions/commit/266efde5395659a45aea124a20d3eb29e95ea457))
* Enable `metadata` field on admonition codeblocks (close [#261](https://github.com/RyzenFromFire/obsidian-admonitions/issues/261)) ([9143f3f](https://github.com/RyzenFromFire/obsidian-admonitions/commit/9143f3f8741ab8c603cc2e88833681ad5c7daae2))
* parent element now receives styles ([1297cc1](https://github.com/RyzenFromFire/obsidian-admonitions/commit/1297cc1659f02b9510669b00034943515fef8365))
* Publish.js creation removed from Admonition as this feature is depreciated. ([17db9dd](https://github.com/RyzenFromFire/obsidian-admonitions/commit/17db9dda0035965d26b00f77c13c7514aff829bd))
* Python Markdown nesting syntax is no longer supported. Use nesting code blocks instead. ([3e65292](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3e6529217ec54f2145d4eec5bb1ba1f687fef228))
* **Readme:** Update Readme to New Iteration ([49c151b](https://github.com/RyzenFromFire/obsidian-admonitions/commit/49c151b3ef980dd4a24e249e20afa95c05d01d34)), closes [#302](https://github.com/RyzenFromFire/obsidian-admonitions/issues/302)
* Removes generated `id` from Admonition elements. ([2f87101](https://github.com/RyzenFromFire/obsidian-admonitions/commit/2f87101ed6ceaf7b7b4ebf5c07063efe476019dc))
* Removes support for Python-style non-codeblock Admonitions. ([b6ad0c4](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b6ad0c4ac146b9a946982b218aae599cf92ff7d4))
* Surface callout metadata onto callout in post processor ([f814019](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f8140192dad90788609d4586c1bfb6e256703145))


### Bug Fixes

* 🐛 MS Doc syntax is no longer case sensitive ([b2de6be](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b2de6be03c5885a2b6fd1c1935276a38a8d1d712))
* 🐛 ordered lists in live preview now render correctly ([72d03b6](https://github.com/RyzenFromFire/obsidian-admonitions/commit/72d03b6d312f45ad1b097b9a67071ba3304de85e))
* 42 ([9742ef3](https://github.com/RyzenFromFire/obsidian-admonitions/commit/9742ef34714caff905f738ef5d305dd67b9f3a90))
* add admonition copy button to MS syntax style admonitions ([7a1fc6c](https://github.com/RyzenFromFire/obsidian-admonitions/commit/7a1fc6ca0ecca6370ac93496fba781a30a8a90f9))
* Add release notes to releases ([ca4d88c](https://github.com/RyzenFromFire/obsidian-admonitions/commit/ca4d88ca8f31078678bcbac3fa96139cc8a6e989))
* added tdlr admonition type (not sure how it got removed) ([c7d14eb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/c7d14eb50b693830d0e8f227777097e411b474f5))
* Adds publish script generation to build ([c47d5f0](https://github.com/RyzenFromFire/obsidian-admonitions/commit/c47d5f0b19b3f36003046607381672b7b0e6a275))
* admonition and callout suggester displays immediately ([#249](https://github.com/RyzenFromFire/obsidian-admonitions/issues/249)) ([6631412](https://github.com/RyzenFromFire/obsidian-admonitions/commit/6631412671a2ea2ccc9f892969e2c8c94a7a0b84))
* Admonition drop shadow setting will now apply to callouts (close [#222](https://github.com/RyzenFromFire/obsidian-admonitions/issues/222)) ([0457ced](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0457ced760384690928a243bc7e391c691ccbdcc))
* Admonition modal image button switched to icon ([02882e7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/02882e7adcb3a280508cf32d13a5f19db74bc729))
* Admonition suggestor is now the full width of the input element ([#190](https://github.com/RyzenFromFire/obsidian-admonitions/issues/190)) ([a3b3c54](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a3b3c54703d4b8128ae1a16687c11dca40144908))
* Admonition titles now take all child nodes from paragraph parent, not just html elements (close [#239](https://github.com/RyzenFromFire/obsidian-admonitions/issues/239)) ([4db9a01](https://github.com/RyzenFromFire/obsidian-admonitions/commit/4db9a01e5dd1cb8dab8387fc14db34b448664a61))
* admonitions render again when restarting app ([5945f02](https://github.com/RyzenFromFire/obsidian-admonitions/commit/5945f022e8138847c1e8c167e6f2007152dbbc73))
* Admonitions updated in settings are no longer moved to the bottom of the list ([54ea584](https://github.com/RyzenFromFire/obsidian-admonitions/commit/54ea584fb19e11a5cd3f0207809e8a231a1e6b47))
* admonitions with custom titles now include them when using the inserted with title command (close [#145](https://github.com/RyzenFromFire/obsidian-admonitions/issues/145)) ([7034477](https://github.com/RyzenFromFire/obsidian-admonitions/commit/7034477ffbcd377a58f2c2308ceec6a7e3f0f314))
* admonitions without titles properly display again (close [#131](https://github.com/RyzenFromFire/obsidian-admonitions/issues/131)) ([b3bd5c2](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b3bd5c2fe1010a85e79c5662dc83752de54f032f))
* clean up settings code ([b36e7e8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b36e7e86d301024fc19a8e770ad594b67865e1d2))
* Click on Admonition codeblocks to edit in LP (close [#278](https://github.com/RyzenFromFire/obsidian-admonitions/issues/278)) ([4d993bb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/4d993bb61b9042eb1cf2565d0205112f28dee508))
* Content element will no longer be added if no content is provided (close [#201](https://github.com/RyzenFromFire/obsidian-admonitions/issues/201)) ([94d7a4b](https://github.com/RyzenFromFire/obsidian-admonitions/commit/94d7a4b956c9c7c7a23480242e27e00c19ac97e0))
* deferred onload to layout ready to improve plugin load times ([a9accc9](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a9accc9b44cdbc0531f7335b5c9d8c6d216c9422))
* delay live preview focus to allow for click events ([8739ad8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/8739ad8a8c6a07ac134048a68209e10521df7adc))
* Disabled `!!!`-style syntax in settings. Legacy support will continue until version 7.0.0. ([14b662d](https://github.com/RyzenFromFire/obsidian-admonitions/commit/14b662d8eb0a5bbc632d23e4d51ef8d639501cc2))
* Explicitly set titles will override the no title setting in callouts (close [#284](https://github.com/RyzenFromFire/obsidian-admonitions/issues/284)) ([22f32d4](https://github.com/RyzenFromFire/obsidian-admonitions/commit/22f32d410b94aed961b57dba44c565877edce393))
* fix several Live Preview / Reading discrepancies ([13dd599](https://github.com/RyzenFromFire/obsidian-admonitions/commit/13dd59939092bceae6c2d9500d11af32aee039aa))
* fixed admonition color issue ([b600bfb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b600bfbac6c0a8077d91aa65717be81782cb4438))
* fixed checkbox behavior in admonitions (close [#135](https://github.com/RyzenFromFire/obsidian-admonitions/issues/135)) ([db3f55e](https://github.com/RyzenFromFire/obsidian-admonitions/commit/db3f55ed96ced410d3129faa38d7275b6613ccc7))
* Fixed checkboxes not working when in blockquotes or nested, including in the MS-Doc syntax (close [#150](https://github.com/RyzenFromFire/obsidian-admonitions/issues/150)) ([202b826](https://github.com/RyzenFromFire/obsidian-admonitions/commit/202b826b4d82e33c0524cde0da6f21f5d33ea0bf))
* fixed color injection for code block admonitions ([fa586c7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/fa586c773828c57bf1bd2aa825332e3d1ec41136))
* fixed error that could happen when editing admonitions ([0983790](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0983790cd930657d69c96c885c23eabcb884987e))
* fixed mathjax rendering (close [#189](https://github.com/RyzenFromFire/obsidian-admonitions/issues/189)) ([79acf7f](https://github.com/RyzenFromFire/obsidian-admonitions/commit/79acf7f3bb426bfc6076a1d17ecaf59aad3af556))
* fixed rpg awesome icons not showing on mobile (close [#122](https://github.com/RyzenFromFire/obsidian-admonitions/issues/122)) ([903f18a](https://github.com/RyzenFromFire/obsidian-admonitions/commit/903f18acca5b5fd49c5680b9d5d2bf2505aeb6d3))
* fixed webpack external modules ([f6c70a7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f6c70a70df01924ff4c38d6972fa7d27102964ae))
* Fixes @javalent/utilities dependency ([1bb3398](https://github.com/RyzenFromFire/obsidian-admonitions/commit/1bb339816a4f1e91e82bee16bcb245f36359946d))
* fixes admonition conversion on mobile ([b4d29fc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/b4d29fc1dc850db6bc08d08156501728c5dba6a7))
* Fixes admonition copy button setting inheritance ([4776da3](https://github.com/RyzenFromFire/obsidian-admonitions/commit/4776da3fe6243ebfaa6d66c3d2419271d01f70a8))
* fixes bug where you couldn't have an empty title for the MSDoc syntax (close [#183](https://github.com/RyzenFromFire/obsidian-admonitions/issues/183)) ([ca3de23](https://github.com/RyzenFromFire/obsidian-admonitions/commit/ca3de23c3ba3e8e7130299ae2144f4b65522ba95))
* fixes callout metadata surfacing not applying to default types ([25b7756](https://github.com/RyzenFromFire/obsidian-admonitions/commit/25b7756884d0bcf0049a20c0fcaa84adb3a2ff1a))
* Fixes casing display issue for custom titles in settings (close [#214](https://github.com/RyzenFromFire/obsidian-admonitions/issues/214)) ([211b323](https://github.com/RyzenFromFire/obsidian-admonitions/commit/211b3239c5faf897336a6f6439f38f237abaa48c))
* Fixes CSS escaping for custom callouts in Obsidian installer 1.4+ ([523ca6a](https://github.com/RyzenFromFire/obsidian-admonitions/commit/523ca6a2874e7825e2151ccd2c83885e45b225ce))
* Fixes default Admonitions not respecting the injectColor setting. ([7cf16f0](https://github.com/RyzenFromFire/obsidian-admonitions/commit/7cf16f063c2a03e7fa6aa33cf7820b2e02422d86))
* Fixes incorrect error being displayed when using an image as an icon (close [#311](https://github.com/RyzenFromFire/obsidian-admonitions/issues/311)) ([099e84c](https://github.com/RyzenFromFire/obsidian-admonitions/commit/099e84cfb78e521d33044a005058b289fcc2d872))
* Fixes issue preventing Settings Search from searching Admonition settings ([d020438](https://github.com/RyzenFromFire/obsidian-admonitions/commit/d02043846a0ad08c678af3c995306c1ff2071682))
* Fixes issue where a type couldn't be renamed ([f8d37ac](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f8d37ace0c528e92e2dbd10908eb684b623974cf))
* Fixes issue where admonition types were being set incorrectly ([06fa0bf](https://github.com/RyzenFromFire/obsidian-admonitions/commit/06fa0bf54b90c68114223bcaf1ad3903cef9fc81))
* Fixes issue where Insert Callout wouldn't insert a `&gt;` on the first line ([c276afe](https://github.com/RyzenFromFire/obsidian-admonitions/commit/c276afea945bda3bbeed9512c2f9eaedcda4834d))
* Fixes issue where removing types from the callout manager was removing the wrong type ([a3435c7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a3435c7fd47534bf43610f5c4f59085bb6a4450b))
* Fixes issue where the admonition suggester crashed (close [#342](https://github.com/RyzenFromFire/obsidian-admonitions/issues/342), close [#343](https://github.com/RyzenFromFire/obsidian-admonitions/issues/343)) ([3356aaf](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3356aafa89216077f41df5b52261afb6d0397e84))
* fixes issue where trying to add a copy content button to a callout with no content ([10db45a](https://github.com/RyzenFromFire/obsidian-admonitions/commit/10db45aee7d13a926ba46ab91c1700e8dc120b17))
* fixes issue with an extra space in msdoc syntax not rendering ([0c08854](https://github.com/RyzenFromFire/obsidian-admonitions/commit/0c0885461f7c410192d70bcf24253b878b129bdf))
* Fixes issue with custom admonitions not working with callouts ([9c9c486](https://github.com/RyzenFromFire/obsidian-admonitions/commit/9c9c486f192c82a3a64d12bc442f05eeb30df4e6))
* fixes issue with icon suggester not loading icons ([4a463d3](https://github.com/RyzenFromFire/obsidian-admonitions/commit/4a463d340a1625daba7bae7739e331c5522d33c0))
* fixes issue with long scrolling notes with new MS syntax in LP (closes [#149](https://github.com/RyzenFromFire/obsidian-admonitions/issues/149)) ([03582c6](https://github.com/RyzenFromFire/obsidian-admonitions/commit/03582c661d77f49a605ae6231681fdadb8a55e92))
* Fixes issue with maintaining a CSS snippet for callouts ([f7efbbc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f7efbbc092b5b9dd9ae88ca3b62af7406a68ad17))
* Fixes issue with Open/Collapse Admonition commands ([6d61851](https://github.com/RyzenFromFire/obsidian-admonitions/commit/6d618518d55fe47e47a66a7ad8bab7924dd205f4))
* Fixes issue with post processors map not getting reinitialized properly ([a7752d9](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a7752d9d4238407e48412d70161598925df21395))
* Fixes MSDoc-syntax in Live Preview ([e4d1cdb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/e4d1cdb7dd0e15b5f1876d8d14dfeb850b85527b))
* fixes obsidian icon definition ([dc05aba](https://github.com/RyzenFromFire/obsidian-admonitions/commit/dc05abac372ce9256bf63aa0872cfa67e07b883d))
* Fixes pandoc and PDF export of blockquotes (close [#192](https://github.com/RyzenFromFire/obsidian-admonitions/issues/192)) ([ba75de8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/ba75de802b10e12ed347d9dd05239e1c3905ca09))
* Fixes several issues with converting code block admonitions to callouts (close [#235](https://github.com/RyzenFromFire/obsidian-admonitions/issues/235)) ([457b388](https://github.com/RyzenFromFire/obsidian-admonitions/commit/457b388f35b6d9dbe8d2bc44e61c36033ada844a))
* Fixes several issues with Live Preview MSDoc syntax rendering (closes [#170](https://github.com/RyzenFromFire/obsidian-admonitions/issues/170)) ([50562db](https://github.com/RyzenFromFire/obsidian-admonitions/commit/50562db72329af76ed07d448af936a7347efac20))
* Fixes title display in admonition creation modal ([1a73421](https://github.com/RyzenFromFire/obsidian-admonitions/commit/1a734212b7ecddeeb400ac4dce4cfc2bfc3493c5))
* improve live preview rendering ([#141](https://github.com/RyzenFromFire/obsidian-admonitions/issues/141)) ([636eb83](https://github.com/RyzenFromFire/obsidian-admonitions/commit/636eb83e18a4bbe484a2a2a9256d56e369204f5e))
* improved live preview styling ([5a0c111](https://github.com/RyzenFromFire/obsidian-admonitions/commit/5a0c11182c4935e491f52248123a98226e631660))
* Improves appearance of Editor suggester ([7652ed0](https://github.com/RyzenFromFire/obsidian-admonitions/commit/7652ed08cc13cfea9f8fad0bae6473706991f286))
* Improves appearance of suggesters (close [#338](https://github.com/RyzenFromFire/obsidian-admonitions/issues/338)) ([e36a4a8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/e36a4a88fbb6590a4acbd78822ab5b6e7d203e36))
* Improves behavior of Admonition edit modal ([72c2bc3](https://github.com/RyzenFromFire/obsidian-admonitions/commit/72c2bc3024957315e8b6c3e1693b59379962ad07))
* improves consistency across different screen sizes ([13dd599](https://github.com/RyzenFromFire/obsidian-admonitions/commit/13dd59939092bceae6c2d9500d11af32aee039aa))
* Improves lifetime of Admonition rendered content ([a045776](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a04577628731ced61b04e40d82afa86dd1c51c79))
* improves live preview detection ([4a941fc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/4a941fc6e0af271bf1996183d19b6a1fd295d2b5))
* insert admonition commands now properly wrap selected text ([758ce51](https://github.com/RyzenFromFire/obsidian-admonitions/commit/758ce516b1e639f0d6829aea866c9d0fa3101747))
* **issues:** Typo in bug-report.yml ([aceb2dc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/aceb2dc1ecb9aced607b4e0ce3d0b901711f278b))
* **issues:** Typo in contibuting.md ([5a7bc32](https://github.com/RyzenFromFire/obsidian-admonitions/commit/5a7bc32da1faa60e907f317977784e4ffd534f11))
* Merge [#355](https://github.com/RyzenFromFire/obsidian-admonitions/issues/355), fixes [#339](https://github.com/RyzenFromFire/obsidian-admonitions/issues/339) ([78ed9dc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/78ed9dc053c5d99f25bf9195987f068fb9aa91cc))
* mixed case custom callout types are supported ([#295](https://github.com/RyzenFromFire/obsidian-admonitions/issues/295)) ([628179e](https://github.com/RyzenFromFire/obsidian-admonitions/commit/628179ee8f2fb5df20114ea33f4d548798ff8a51))
* partial fix for LP display issues ([85ca7b7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/85ca7b7d0c6553a4b01f4e327d8b86c2351530cf))
* Pass component to renderMarkdown ([dfcf140](https://github.com/RyzenFromFire/obsidian-admonitions/commit/dfcf140e6f024ac8792292b771d9476f44fe3c20))
* propagate source to admonition element (close [#314](https://github.com/RyzenFromFire/obsidian-admonitions/issues/314)) ([f5ec0bb](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f5ec0bbe172f57a9bdf0ea78313b53e37ba66cb7))
* Properly handles the icon manager not finding an icon node ([4470170](https://github.com/RyzenFromFire/obsidian-admonitions/commit/44701700e3209a82de836bb139c015f1896b2108))
* reduced margin on content inside admonitions without titles (close [#185](https://github.com/RyzenFromFire/obsidian-admonitions/issues/185)) ([643ca8e](https://github.com/RyzenFromFire/obsidian-admonitions/commit/643ca8e866f468358b0ca40e4064e68b30d588c9))
* Remove Changelog boilerplate from release notes ([9ab1d18](https://github.com/RyzenFromFire/obsidian-admonitions/commit/9ab1d18d4164e64ba74dcc151eff6cf1485ccb93))
* remove notify from release workflow ([440cb29](https://github.com/RyzenFromFire/obsidian-admonitions/commit/440cb29ba81269e54654656e972e11c2247e72e4))
* remove publish build step ([fc9bbfc](https://github.com/RyzenFromFire/obsidian-admonitions/commit/fc9bbfcd09c9214b48df365552085128a6711a43))
* remove timestamp from auto-generated css (close [#327](https://github.com/RyzenFromFire/obsidian-admonitions/issues/327)) ([8952e8e](https://github.com/RyzenFromFire/obsidian-admonitions/commit/8952e8ef70bae7500b1f70445a96949621897317))
* remove webpack ([00a22aa](https://github.com/RyzenFromFire/obsidian-admonitions/commit/00a22aa276b533838b3c398331138fc222571ba5))
* removed logs ([6a56b70](https://github.com/RyzenFromFire/obsidian-admonitions/commit/6a56b706ed2248b4d142c37e7c314a4e5d6e68c9))
* Removed old polyfill, fixed app layout ready call ([2ab15f1](https://github.com/RyzenFromFire/obsidian-admonitions/commit/2ab15f101d193061cc13523465decbbf25527efa))
* removes console logs from publish script ([43cd171](https://github.com/RyzenFromFire/obsidian-admonitions/commit/43cd171976d243cb00a1bfad03d4860509f6a58d))
* removes need for space to show callout suggester fixes [#293](https://github.com/RyzenFromFire/obsidian-admonitions/issues/293) ([db50d92](https://github.com/RyzenFromFire/obsidian-admonitions/commit/db50d922af79d66a27b188df93189db19b8bae8b))
* respect inject color setting on callouts ([2700861](https://github.com/RyzenFromFire/obsidian-admonitions/commit/270086151f7b4018936491df3d54ea7e3987038b))
* settings ui fixes ([fd46a25](https://github.com/RyzenFromFire/obsidian-admonitions/commit/fd46a25e478cf85c9782934e60e21798418ef1a8))
* Significant improvements to the publish feature for code blocks. ([ce644a5](https://github.com/RyzenFromFire/obsidian-admonitions/commit/ce644a5dc22b56226479a4c8dd5fc4fd4a8d6a21))
* switch to Obsidian's Live Preview State Facet ([a9e43f9](https://github.com/RyzenFromFire/obsidian-admonitions/commit/a9e43f93d8a0dfbddbeaf9a23d1f3df6e7513062))
* switch to release-please ([5e0ee1a](https://github.com/RyzenFromFire/obsidian-admonitions/commit/5e0ee1ad0522d7715d6b4c51d4b018f1eda8e5a4))
* Temporarily remove Export Custom Types button from mobile until it can be fixed ([f56ebb8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f56ebb8a69a8aca41794058838ac993733d6a17e))
* update publish reference to scss ([bf949d7](https://github.com/RyzenFromFire/obsidian-admonitions/commit/bf949d7e8d2eaf8e4d1a78815197f78cb8d61bab))
* Update release notes again ([e9ba91f](https://github.com/RyzenFromFire/obsidian-admonitions/commit/e9ba91f727a4c61ab9249f668c18760679616b2c))
* update to new obsidian customCss definition ([518b3d3](https://github.com/RyzenFromFire/obsidian-admonitions/commit/518b3d396f76ca96e673f3f0c5610646f78e4188))
* use custom title in InsertAdmonitionModal ([#296](https://github.com/RyzenFromFire/obsidian-admonitions/issues/296)) ([3e17d60](https://github.com/RyzenFromFire/obsidian-admonitions/commit/3e17d60f706bfd420d31f1659d8b42ee43ec88f0))
* version bump oops ([d4d0098](https://github.com/RyzenFromFire/obsidian-admonitions/commit/d4d00985d6621d7e7d16caade8efa460aee42a26))
* warned about future removal of `!!!`-style syntax ([cc183a8](https://github.com/RyzenFromFire/obsidian-admonitions/commit/cc183a8cbae2c78bdc09d7b9a8d853534abed9a1))


### Miscellaneous Chores

* release 10.3.3 ([f88934b](https://github.com/RyzenFromFire/obsidian-admonitions/commit/f88934b601d1c8f14aca18d7a172f5263e50030f))
